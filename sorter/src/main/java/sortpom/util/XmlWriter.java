...
/**
 * Base class for the writers used when outputting XML. Limits some of the methods that wont be used
 * in the writers (less testing for me). Removes IOException from the signature for some methods
 * (less coding for me).
 */
