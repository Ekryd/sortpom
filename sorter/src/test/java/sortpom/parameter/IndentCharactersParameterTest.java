...
class IndentCharactersParameterTest {
  ...
  void zeroIndentCharactersShouldResultInEmptyIndentString() {
    var pluginParameters = PluginParameters.builder().setIndent(0, true, null).build();
  ...
  void oneIndentCharacterShouldResultInOneSpace() {
    var pluginParameters = PluginParameters.builder().setIndent(1, true, null).build();
  ...
  void test255IndentCharacterShouldResultIn255Space() {
    var pluginParameters = PluginParameters.builder().setIndent(255, true, null).build();
  ...
  void minusTwoShouldFail() {
    Executable testMethod = () -> PluginParameters.builder().setIndent(-2, true, null).build();
  ...
  void moreThan255ShouldFail() {
    Executable testMethod = () -> PluginParameters.builder().setIndent(256, true, null).build();
