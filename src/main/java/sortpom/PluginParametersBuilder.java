...
public class PluginParametersBuilder {
    ...
    public PluginParametersBuilder setFormatting(final String encoding, final String lineSeparator, final String indentCharacters) {
    ...
    public PluginParameters createPluginParameters() {
        return new PluginParameters(pomFile, createBackupFile, backupFileExtension, encoding, lineSeparator, indentCharacters, predefinedSortOrder, sortOrderFile, sortDependencies, sortPlugins);
    }
}